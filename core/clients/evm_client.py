...
GAS_LIMIT_MULTIPLIER = CONFIG_FILE["settings"]["transactions"]["gas_limit_multiplier"]
GAS_PRICE_MULTIPLIER = CONFIG_FILE["settings"]["transactions"]["gas_price_multiplier"]
GAS_AMT_MULTIPLIER = CONFIG_FILE["settings"]["transactions"]["gas_amt_multiplier"]
MAX_DST_WAIT_TIME = CONFIG_FILE["settings"]["transactions"]["max_dst_wait_time"]
ACCEPTABLE_L1_GWEI = CONFIG_FILE["settings"]["transactions"]["acceptable_l1_gwei"]
MAX_RETRIES = CONFIG_FILE["settings"]["general"]["max_retries"]
...
class EvmClient:
    ...
    def __init__(
        ...
        from data.config import PROXY_CYCLE
